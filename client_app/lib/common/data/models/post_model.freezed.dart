...
@override
String toString() {
  return 'PostModel(id: $id, title: $title, content: $content, author: $author, likeCount: $likeCount, commentCount: $commentCount)';
}
...
class _PostModel implements PostModel {
   _PostModel({required this.id, required this.title, required this.content, required this.author, required this.likeCount, required this.commentCount});
